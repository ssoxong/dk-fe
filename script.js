document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchPosts() {
        const response = await fetch('https://vercel-fastapi-deployment.onrender.com/posts');
    ...
    async function fetchPost() {
        if (postContent) {
            ...
            if (id !== null) {
                const response = await fetch(`https://vercel-fastapi-deployment.onrender.com/posts/${id}`);
    ...
    async function fetchComments(postId) {
        if (commentsContainer) {
            const response = await fetch(`https://vercel-fastapi-deployment.onrender.com/posts/${postId}/comments`);
